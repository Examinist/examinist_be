class StaffPortal::QuestionsController < ApplicationController
  ...
  def create_question_params
    params.permit(:header, :difficulty, :number_of_choices, :answer_type, :question_type_id, :topic_id, choices_attributes: [:choice],
                  correct_answers_attributes: [:answer])
  end

  def update_question_params
    params.permit(:header, :difficulty, :number_of_choices, :answer_type, :topic_id, choices_attributes: %i[id _destroy choice],
