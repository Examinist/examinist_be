class StaffPortal::QuestionsController < ApplicationController
  ...
  def index
    ...
    render_response({ questions: StaffPortal::QuestionSerializer.new(records.order(updated_at: :desc)).to_j }, :ok, pagination: number_of_pages)
  end
  ...
  def create
    ...
    render_response({ question: StaffPortal::QuestionSerializer.new(question, params: { show_details: true }).to_j }, :created)
  end
  ...
  def update
    ...
    render_response({ question: StaffPortal::QuestionSerializer.new(@question, params: { show_details: true }).to_j }, :ok)
  end
